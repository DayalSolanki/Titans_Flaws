        ...
        <>{depLoading ? <div>Loading ...</div> : 
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type='text' name='Dep Name' onChange={handleChange} placeholder='Department Name'
                     value={department.dep_name} className='mt-1 w-full p-2 border border-gray-300 rounded-md' required/>
                </div>
                <div className='mt-3'>
                    <label htmlFor="description" className='block text-sm font-medium text-gray-700'>Description</label>
                    <textarea name="description" placeholder='description' rows="4" onChange={handleChange}
                      value={department.description}  className='mt-2 p-2 block w-full border border-gray-300 rounded-md'>
                    </textarea>
                </div>
